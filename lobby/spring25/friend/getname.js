...
function insert(){
	...
	if(name=='undefined' || utreat == 'undefined'){
		document.body.innerHTML=document.body.innerHTML.replaceAll("[$REPLACE-UNAME$]","")
	}else{
		document.body.innerHTML=document.body.innerHTML.replace("[$REPLACE-UNAME$]",name).replace("[$REPLACE-UNAME$]",name+"?")
	}
