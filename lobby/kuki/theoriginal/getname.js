...
function insert(){
	...
	if(name=='undefined' || utreat == 'undefined'){
		document.body.innerHTML=document.body.innerHTML.replace("[$REPLACE-UTREAT$]","")
	}else{
		document.body.innerHTML=document.body.innerHTML.replace("[$REPLACE-UTREAT$]","Even with "+utreat+"! Im sure, "+name+" will be so happy to see that!")
	}
